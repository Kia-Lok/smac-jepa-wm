...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--probe-max-batches-per-epoch", type=int, default=200)
    parser.add_argument("--probe-samples-per-epoch", type=int, default=10000)
    ...
    for epoch in range(1, args.probe_epochs + 1):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.no_grad(), autocast_context:
                true_latent = model.encoder(full_entity_seq, full_entity_mask)
...
def evaluate_one_checkpoint(
    ...
    for batch in loader:
        ...
        with torch.no_grad(), autocast_context:
            ...
            if rollout_horizon == int(cfg.get("rollout_horizon", 5)):
