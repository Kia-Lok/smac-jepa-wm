...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=1.0,
        help=(
            "Per-dimension latent standard-deviation floor. "
            "A value of 1.0 matches the scale encouraged by SIGReg."
        ),
    )
...
def main() -> None:
    ...
    saved_config = vars(args) | arch | {
        ...
        "training_regime": "markov_rollout_rnn_seqmem_barlow_scale_safe",
        "enemy_visibility_mask": args.enemy_visibility_mask,
        "enemy_sight_range": args.enemy_sight_range,
    ...
    print(
        "markov_rollout_rnn_visibility_seqmem_barlow_scale_safe "
        ...
        f"latent_std_floor={args.latent_std_floor} "
